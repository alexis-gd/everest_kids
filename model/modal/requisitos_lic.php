    <!-- Modal requisitos -->
    <div class="modal fade modal-color" id="requisitosLic" tabindex="-1" aria-labelledby="requisitosLicLabel" aria-hidden="true">
                    ...
                    <div class="box-requisitos">
                      <?php
                        ...
                        $conexion->set_charset('utf8');
                          $sql = "SELECT * FROM requisitos WHERE grado = 'Licenciatura' AND status = '1'";
