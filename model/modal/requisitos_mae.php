    <!-- Modal requisitos -->
    <div class="modal fade modal-color" id="requisitosMae" tabindex="-1" aria-labelledby="requisitosMaeLabel" aria-hidden="true">
                    ...
                    <div class="box-requisitos">
                      <?php
                        ...
                        $conexion->set_charset('utf8');
                          $sql = "SELECT * FROM requisitos WHERE grado = 'Maestría' AND status = '1'";
